...
public class UpdatePurchaseOrderCommand {
    ...
    public UpdatePurchaseOrderCommand(UUID purchaseOrderId, String purchaseOrderNumber, String customerNumber, 
                                   String customerName, UUID sellerId, String sellerName, 
                                   LocalDateTime orderDate, List<PurchaseOrderLineCommand> orderLines) {
